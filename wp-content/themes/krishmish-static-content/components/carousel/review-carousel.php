            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="media">
                        <div class="media-left d-flex mr-3">
                            <a href="#">
                                <img src="<?=get_template_directory_uri();?>/assets/images/man.png" alt="customer">
                            </a>
                        </div>
                ...
                <div class="col-sm-6">
                    <div class="media">
                        <div class="media-left d-flex mr-3">
                            <a href="#">
                                <img src="<?=get_template_directory_uri();?>/assets/images/single_person_female.png" alt="customer">
                            </a>
                        </div>
                        <div class="media-body">
                            <div class="testimonial">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="media">
                        <div class="media-left d-flex mr-3">
                            <a href="#">
                                <img src="<?=get_template_directory_uri();?>/assets/images/single_person_male.png" alt="customer">
                            </a>
                        </div>
                        <div class="media-body">
                            <div class="testimonial">
                ...
                <div class="col-sm-6">
                    <div class="media">
                        <div class="media-left d-flex mr-3">
                            <a href="#">
                                <img src="<?=get_template_directory_uri();?>/assets/images/woman_icon.png" alt="customer">
                            </a>
                        </div>
                        <div class="media-body">
                            <div class="testimonial">
